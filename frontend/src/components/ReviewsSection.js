...
export default function ReviewsSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        toast.error("حدث خطأ أثناء الإرسال. قد تكون أضفت تقييمًا بالفعل.");
    }
  };
                ...
                <div className="bg-slate-900 p-8 rounded-2xl w-full max-w-md border border-slate-700">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex gap-3">
                            <button type="submit" className="flex-1 bg-amber-500 text-black font-bold py-3 rounded-xl">نشر التقييم</button>
