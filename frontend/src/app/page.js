...
//                 <button
//                   onClick={() => setAuthOpen(true)}
//                   className="bg-amber-500 text-black px-6 py-2.5 rounded-full font-bold text-sm hover:bg-amber-400 transition-all"
//                 >
//                   <UserCircleIcon className="h-5 w-5" />
//                   <span>دخول الأعضاء</span>
//                 </button>
...
//           {/* CTA Button */}
//           <a href="#collection" className="inline-flex items-center gap-3 bg-amber-500 text-black font-bold py-4 px-12 rounded-full text-xl shadow-2xl hover:bg-amber-400 transition-all">
//             <span>اكتشف المجموعة</span>
//             <ChevronDownIcon className="h-6 w-6 animate-bounce" />
//           </a>
//         </div>
...
//       {/* MAIN CONTENT */}
//       <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
//         {/* BEST SELLERS SECTION - Horizontal Slider with Autoplay */}
//         {bestSellers.length > 0 && (
//           <div className="mb-20">
//             {/* Section Header */}
//             <div className="flex items-center justify-center gap-4 mb-10">
...
//         {/* CATEGORY SECTIONS - Each as Horizontal Slider with Autoplay */}
//         {productsByCategory.map((category) => {
//           if (category.products.length === 0) return null;
...
//       {/* Use the original ReviewsSection component */}
//       <ReviewsSection />
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (userInfo) {
      ...
      setAuthMessage(`مرحباً ${parsedUser.name || parsedUser.username}!`);
  ...
  const logoutHandler = () => {
    localStorage.removeItem('userInfo');
    setUser(null);
    setAuthMessage('تم تسجيل الخروج بنجاح');
    setTimeout(() => setAuthMessage(''), 3000);
    window.location.reload();
  };
  ...
  const handleAuthSuccess = (userData) => {
    setUser(userData);
    setAuthOpen(false);
    setAuthMessage(`مرحباً ${userData.name || userData.username}! تم تسجيل الدخول بنجاح`);
    setTimeout(() => setAuthMessage(''), 3000);
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-amber-500 selection:text-black">
      ...
      {authMessage && (
        <div className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 bg-emerald-600 text-white px-6 py-3 rounded-lg shadow-xl animate-slideDown">
          <div className="flex items-center gap-2">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              {user ? (
                ...
                <button
                  onClick={() => setAuthOpen(true)}
                  className="hidden lg:flex items-center gap-2 bg-gold hover:bg-amber-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-amber-500/25"
                >
                  <UserCircleIcon className="h-5 w-5" />
                  <span>دخول الأعضاء</span>
                </button>
              ...
              <div className="flex flex-col gap-1 px-2">
                ...
                {user ? (
                  ...
                  <button
                    ...
                    className="mt-2 flex items-center gap-2 bg-gold text-white py-3 px-4 rounded-lg text-sm font-medium justify-center"
                  >
                    <UserCircleIcon className="h-5 w-5" />
                    <span>دخول الأعضاء</span>
                  </button>
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-30 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* CTA Button - Fixed Contrast */}
          <a
            href="#collection"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white font-semibold py-4 px-10 rounded-full text-lg shadow-2xl shadow-amber-500/25 hover:shadow-amber-500/40 transition-all duration-300 transform hover:-translate-y-1"
          >
            <span>اكتشف المجموعة</span>
            <ChevronDownIcon className="h-5 w-5 animate-bounce" />
          </a>
...
<div className="bg-gradient-to-b from-slate-900 to-slate-950 py-20 md:py-28">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="relative group">
      ...
      {/* MODALS - Updated to handle auth success */}
      <AuthModal 
        isOpen={isAuthOpen} 
